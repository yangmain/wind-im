 ...
 * @since 2018-04-03 18:25:36
 */
public class SyncNoticeHandler extends AbstractSyncHandler<Command> {
	private static final Logger logger = LoggerFactory.getLogger(SyncNoticeHandler.class);

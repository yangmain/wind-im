 ...
 * @since 2018-04-26 15:13:53
 */
public class GroupMessageTextHandler extends AbstractGroupHandler<Command> {
	private static final Logger logger = LoggerFactory.getLogger(GroupMessageTextHandler.class);

 ...
 * @since 2018-05-08 18:30:07
 */
public class WebChatReceiveMessageHandler {
	private static final Logger logger = LoggerFactory.getLogger(WebChatReceiveMessageHandler.class);
